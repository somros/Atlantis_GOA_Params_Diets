...
calculate_diet_prop <- function(pred_stage,prey_stage){
  ...
  # write this out
  write.csv(diet_all_years,paste("../output/dietprop_pred_stratum_",pred_stage,"prey",prey_stage,".csv",sep = "_"), row.names = F)
  ...
  ggsave(paste("../output/dietprop_pred_stratum_",pred_stage,"prey",prey_stage,".png",sep = "_"),p,width = 16, height = 12)
}
