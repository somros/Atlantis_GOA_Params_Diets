...
calculate_diet_prop <- function(pred_stage,prey_stage){
  ...
  # write this out
  write.csv(diet_all_years,paste("../output/REEM/dietprop_stratum_pred_",pred_stage,"_prey",prey_stage,".csv",sep = ""), row.names = F)
  ...
  ggsave(paste("../output/REEM/dietprop_stratum_pred_",pred_stage,"_prey",prey_stage,".png",sep = ""),p,width = 16, height = 12)
}
